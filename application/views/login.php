...
<head>
    ...
    <title>Login | KEY2 RESTAURANT</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">KEY2<b>RESTAURANT</b></a>
            <small>Tempat Makan Kita Semua</small>
        </div>
        <div class="card">
            <div class="body">
                <?php echo form_open("init/touch/auth") ?>
                   <?= ($this->session->flashdata("msg")) ? $this->session->flashdata("msg") : false ?>
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="namauser" placeholder="Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
